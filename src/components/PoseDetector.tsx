...
import { Camera } from ".";
import type { pose } from "@src/utils/detector";
import { detectSlope, detectTextNeck } from "@src/utils/detector";
import { drawPose } from "@src/utils/drawer";
...
const PoseDetector: React.FC = () => {
  ...
  const requestApi = (delay: number): Promise<void> =>
    ...
    <div>
      {isScriptError ? (
        ...
        <>
          ...
          />
          {isModelLoaded ? (
            <button onClick={getInitSnap}>get snap</button>
          ) : null}
